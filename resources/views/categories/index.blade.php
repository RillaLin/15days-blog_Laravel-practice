            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Category Admin Panel</li>
                    </ol>
</nav>
                </div>
            </div>
    ...
    <section class="body-content ">
        ...
        <div class="page-content">
            <div class="container">
                ...
                <ul class="list-group">
                    @foreach($categories as $key=> $category) <!--把每一個post拿出來印-->
                        <li class="list-group-item clearfix"> <!--改為ul，a裡面放a會出錯-->
                            ...
                            <div class="float-right">  <!--浮右-->
                                ...
                                <button class="btn btn-danger" onclick="deleteCategory({{$category->id}})">Delete</button> <!--把後端id塞到前端-->
                            </div>
                        </li>
                    @endforeach
